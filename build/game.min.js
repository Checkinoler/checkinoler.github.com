...
d.isCrossOrigin&&"file://"!==location.origin&&(n.crossOrigin="Anonymous");var p=function(){this.removeEventListener("load",p,!1);this.removeEventListener("error",r,!1);f.test(a)||(cc.loader.cache[a]=n);var b=e[a];if(b){callbacks=b.callbacks;for(var c=0;c<callbacks.length;++c){var d=callbacks[c];d&&d(null,n)}b.img=null;delete e[a]}},s=this,r=function(){this.removeEventListener("error",r,!1);if(n.crossOrigin&&"anonymous"===n.crossOrigin.toLowerCase())d.isCrossOrigin=!1,s.release(a),cc.loader.loadImg(a,
d,c);else{var b=e[a];if(b){callbacks=b.callbacks;for(var f=0;f<callbacks.length;++f){var h=callbacks[f];h&&h("load image failed")}b.img=null;delete e[a]}}};e[a]={img:n,callbacks:c?[c]:[]};n.addEventListener("load",p);n.addEventListener("error",r);n.src=a;return n},_loadResIterator:function(a,c,d){var e=this,n=null,p=a.type;p?(p="."+p.toLowerCase(),n=a.src?a.src:a.name+p):(n=a,p=cc.path.extname(n));if(c=e.getRes(n))return d(null,c);c=null;p&&(c=b[p.toLowerCase()]);if(!c)return cc.error("loader for ["+
p+"] not exists!"),d();p=n;f.test(n)||(p=c.getBasePath?c.getBasePath():e.resPath,p=e.getUrl(p,n));cc.game.config.noCache&&"string"===typeof p&&(p=e._noCacheRex.test(p)?p+("\x26_t\x3d"+(new Date-0)):p+("?_t\x3d"+(new Date-0)));c.load(p,n,a,function(a,b){a?(cc.log(a),e.cache[n]=null,delete e.cache[n],d({status:520,errorMessage:a},null)):(e.cache[n]=b,d(null,b))})},_noCacheRex:/\?/,getUrl:function(a,d){var e=cc.path;if(void 0!==a&&void 0===d){d=a;var f=e.extname(d),f=f?f.toLowerCase():"";a=(f=b[f])?
...
a.LANGUAGE_ENGLISH;a.language=k;var m=k=!1,v="",w=0,A=/android (\d+(?:\.\d+)+)/i.exec(h)||/android (\d+(?:\.\d+)+)/i.exec(c.platform);A&&(k=!0,v=A[1]||"",w=parseInt(v)||0);if(A=/(iPad|iPhone|iPod).*OS ((\d+_?){2,3})/i.exec(h))m=!0,v=A[2]||"",w=parseInt(v)||0;A=a.OS_UNKNOWN;-1!==c.appVersion.indexOf("Win")?A=a.OS_WINDOWS:m?A=a.OS_IOS:-1!==c.appVersion.indexOf("Mac")?A=a.OS_OSX:-1!==c.appVersion.indexOf("X11")&&-1===c.appVersion.indexOf("Linux")?A=a.OS_UNIX:k?A=a.OS_ANDROID:-1!==c.appVersion.indexOf("Linux")&&
(A=a.OS_LINUX);a.os=A;a.osVersion=v;a.osMainVersion=w;a.browserType=a.BROWSER_TYPE_UNKNOWN;(function(){var b=/qqbrowser|chrome|safari|firefox|opr|oupeng|opera/i,c=/mqqbrowser|sogou|qzone|liebao|micromessenger|ucbrowser|360 aphone|360browser|baiduboxapp|baidubrowser|maxthon|mxbrowser|trident|miuibrowser/i.exec(h);c||(c=b.exec(h));b=c?c[0]:a.BROWSER_TYPE_UNKNOWN;"micromessenger"===b?b=a.BROWSER_TYPE_WECHAT:"safari"===b&&h.match(/android.*applewebkit/)?b=a.BROWSER_TYPE_ANDROID:"trident"===b?b=a.BROWSER_TYPE_IE:
...
a.getImageData(0,0,1,1).data[0]}();cc.sys.isMobile&&(k=document.createElement("style"),k.type="text/css",document.body.appendChild(k),k.textContent="body,canvas,div{ -moz-user-select: none;-webkit-user-select: none;-ms-user-select: none;-khtml-user-select: none;-webkit-tap-highlight-color:rgba(0,0,0,0);}");try{var x=a.localStorage=b.localStorage;x.setItem("storage","");x.removeItem("storage");x=null}catch(B){x=function(){cc.warn("Warning: localStorage isn't enabled. Please confirm browser cookie or privacy option")},
a.localStorage={getItem:x,setItem:x,removeItem:x,clear:x}}x=!!f.getContext("2d");k=!1;if(b.WebGLRenderingContext){m=document.createElement("CANVAS");try{if(cc.create3DContext(m,{stencil:!0,preserveDrawingBuffer:!0})&&(k=!0),k&&a.os===a.OS_ANDROID)switch(a.browserType){case a.BROWSER_TYPE_MOBILE_QQ:case a.BROWSER_TYPE_BAIDU:case a.BROWSER_TYPE_BAIDU_APP:k=6.2<=parseFloat(a.browserVersion)?!0:!1;break;case a.BROWSER_TYPE_ANDROID:a.osMainVersion&&5<=a.osMainVersion&&(k=!0);break;case a.BROWSER_TYPE_UNKNOWN:case a.BROWSER_TYPE_360:case a.BROWSER_TYPE_MIUI:k=
!1}}catch(C){}m=null}x=a.capabilities={canvas:x,opengl:k};if(void 0!==e.ontouchstart||void 0!==d.ontouchstart||c.msPointerEnabled)x.touches=!0;void 0!==e.onmouseup&&(x.mouse=!0);void 0!==e.onkeyup&&(x.keyboard=!0);if(b.DeviceMotionEvent||b.DeviceOrientationEvent)x.accelerometer=!0;a.garbageCollect=function(){};a.dumpRoot=function(){};a.restartVM=function(){};a.cleanScript=function(a){};a.isObjectValid=function(a){return a?!0:!1};a.dump=function(){var a;a=""+("isMobile : "+this.isMobile+"\r\n");a+=
"language : "+this.language+"\r\n";a+="browserType : "+this.browserType+"\r\n";a+="browserVersion : "+this.browserVersion+"\r\n";a+="capabilities : "+JSON.stringify(this.capabilities)+"\r\n";a+="os : "+this.os+"\r\n";a+="osVersion : "+this.osVersion+"\r\n";a+="platform : "+this.platform+"\r\n";a+="Using "+(cc._renderType===cc.game.RENDER_TYPE_WEBGL?"WEBGL":"CANVAS")+" renderer.\r\n";cc.log(a)};a.openURL=function(a){window.open(a)}})();g=f=null;cc.log=cc.warn=cc.error=cc.assert=function(){};var h=
{},k=!1,m=null;cc._engineLoaded=!1;cc.initEngine=function(b,c){if(k){var f=m;m=function(){f&&f();c&&c()}}else m=c,!cc.game.config&&b?cc.game.config=b:cc.game.config||cc.game._loadConfig(),b=cc.game.config,a(b),document.body?d(b):cc._addEventListener(window,"load",e,!1),k=!0}})();
...
cc.container=f=document.createElement("DIV"),c.parentNode&&c.parentNode.insertBefore(f,c)):("DIV"!==e.tagName&&cc.log("Warning: target element is not a DIV or CANVAS"),a=a||e.clientWidth,b=b||e.clientHeight,this.canvas=cc._canvas=c=document.createElement("CANVAS"),this.container=cc.container=f=document.createElement("DIV"),e.appendChild(f));f.setAttribute("id","Cocos2dGameContainer");f.appendChild(c);this.frame=f.parentNode===document.body?document.documentElement:f.parentNode;c.addClass("gameCanvas");
c.setAttribute("width",a||480);c.setAttribute("height",b||320);c.setAttribute("tabindex",99);c.style.outline="none";e=f.style;e.width=(a||480)+"px";e.height=(b||320)+"px";e.margin="0 auto";e.position="relative";e.overflow="hidden";f.top="100%";cc._renderType===cc.game.RENDER_TYPE_WEBGL&&(this._renderContext=cc._renderContext=cc.webglContext=cc.create3DContext(c,{stencil:!0,preserveDrawingBuffer:!0,antialias:!cc.sys.isMobile,alpha:!1}));this._renderContext?(cc.renderer=cc.rendererWebGL,d.gl=this._renderContext,
cc.renderer.init(),cc.shaderCache._init(),cc._drawingUtil=new cc.DrawingPrimitiveWebGL(this._renderContext),cc.textureCache._initializingRenderer(),cc.glExt={},cc.glExt.instanced_arrays=gl.getExtension("ANGLE_instanced_arrays"),cc.glExt.element_uint=gl.getExtension("OES_element_index_uint")):(cc.renderer=cc.rendererCanvas,this._renderContext=cc._renderContext=new cc.CanvasContextWrapper(c.getContext("2d")),cc._drawingUtil=cc.DrawingPrimitiveCanvas?new cc.DrawingPrimitiveCanvas(this._renderContext):
null);cc._gameDiv=f;cc.game.canvas.oncontextmenu=function(){if(!cc._isContextMenuEnable)return!1};this.dispatchEvent(this.EVENT_RENDERER_INITED,!0);this._rendererInitialized=!0}},_initEvents:function(){var a=window,b,c;this._eventHide=this._eventHide||new cc.EventCustom(this.EVENT_HIDE);this._eventHide.setUserData(this);this._eventShow=this._eventShow||new cc.EventCustom(this.EVENT_SHOW);this._eventShow.setUserData(this);this.config[this.CONFIG_KEY.registerSystemEvent]&&cc.inputManager.registerSystemEvent(this.canvas);
...
arguments))})):console&&console.log.apply&&(cc.error=function(){return console.error.apply(console,arguments)},cc.assert=function(a,b){if(!a&&b){for(var c=2;c<arguments.length;c++)b=b.replace(/(%s)|(%d)/,cc._formatString(arguments[c]));throw Error(b);}},a!==b.DEBUG_MODE_ERROR&&(cc.warn=function(){return console.warn.apply(console,arguments)}),a===b.DEBUG_MODE_INFO&&(cc.log=function(){return console.log.apply(console,arguments)}))}};cc.SimplePool=function(){this._pool=[]};cc.SimplePool.prototype={constructor:cc.SimplePool,size:function(){return this._pool.length},put:function(a){a&&-1===this._pool.indexOf(a)&&this._pool.unshift(a)},get:function(){var a=this._pool.length-1;if(0>a)return null;var b=this._pool[a];this._pool.length=a;return b},find:function(a,b){var c,d,e,f=this._pool,g=f.length-1;for(d=f.length;0<=d;--d)if(e=f[d],c=a(d,e))return f[d]=f[g],f.length=g,e;return b&&(c=b(),0<=c)?(f[c]=f[g],f.length=g,e):null}};cc.loader.loadBinary=function(a,b){var c=this,d=this.getXMLHttpRequest(),e="load "+a+" failed!";d.open("GET",a,!0);cc.loader.loadBinary._IEFilter?(d.setRequestHeader("Accept-Charset","x-user-defined"),d.onreadystatechange=function(){if(4===d.readyState&&200===d.status){var a=cc._convertResponseBodyToText(d.responseBody);b(null,c._str2Uint8Array(a))}else b(e)}):(d.overrideMimeType&&d.overrideMimeType("text/plain; charset\x3dx-user-defined"),d.onload=function(){4===d.readyState&&200===d.status?b(null,
...
cc.VERTEX_ATTRIB_TEX_COORDS=2;cc.VERTEX_ATTRIB_MAX=7;cc.UNIFORM_PMATRIX=0;cc.UNIFORM_MVMATRIX=1;cc.UNIFORM_MVPMATRIX=2;cc.UNIFORM_TIME=3;cc.UNIFORM_SINTIME=4;cc.UNIFORM_COSTIME=5;cc.UNIFORM_RANDOM01=6;cc.UNIFORM_SAMPLER=7;cc.UNIFORM_MAX=8;cc.SHADER_POSITION_TEXTURECOLOR="ShaderPositionTextureColor";cc.SHADER_SPRITE_POSITION_TEXTURECOLOR="ShaderSpritePositionTextureColor";cc.SHADER_POSITION_TEXTURECOLORALPHATEST="ShaderPositionTextureColorAlphaTest";
...
cc.Vertex2F=function(a,b,c,d){this._arrayBuffer=c||new ArrayBuffer(cc.Vertex2F.BYTES_PER_ELEMENT);this._offset=d||0;this._xF32=new Float32Array(this._arrayBuffer,this._offset,1);this._yF32=new Float32Array(this._arrayBuffer,this._offset+4,1);this._xF32[0]=a||0;this._yF32[0]=b||0};cc.Vertex2F.BYTES_PER_ELEMENT=8;_p=cc.Vertex2F.prototype;_p._getX=function(){return this._xF32[0]};_p._setX=function(a){this._xF32[0]=a};_p._getY=function(){return this._yF32[0]};_p._setY=function(a){this._yF32[0]=a};
cc.defineGetterSetter(_p,"x",_p._getX,_p._setX);cc.defineGetterSetter(_p,"y",_p._getY,_p._setY);cc.Vertex3F=function(a,b,c,d,e){this._arrayBuffer=d||new ArrayBuffer(cc.Vertex3F.BYTES_PER_ELEMENT);this._offset=e||0;d=this._arrayBuffer;e=this._offset;this._xF32=new Float32Array(d,e,1);this._xF32[0]=a||0;this._yF32=new Float32Array(d,e+Float32Array.BYTES_PER_ELEMENT,1);this._yF32[0]=b||0;this._zF32=new Float32Array(d,e+2*Float32Array.BYTES_PER_ELEMENT,1);this._zF32[0]=c||0};
cc.Vertex3F.BYTES_PER_ELEMENT=12;_p=cc.Vertex3F.prototype;_p._getX=function(){return this._xF32[0]};_p._setX=function(a){this._xF32[0]=a};_p._getY=function(){return this._yF32[0]};_p._setY=function(a){this._yF32[0]=a};_p._getZ=function(){return this._zF32[0]};_p._setZ=function(a){this._zF32[0]=a};cc.defineGetterSetter(_p,"x",_p._getX,_p._setX);cc.defineGetterSetter(_p,"y",_p._getY,_p._setY);cc.defineGetterSetter(_p,"z",_p._getZ,_p._setZ);
cc.Tex2F=function(a,b,c,d){this._arrayBuffer=c||new ArrayBuffer(cc.Tex2F.BYTES_PER_ELEMENT);this._offset=d||0;this._uF32=new Float32Array(this._arrayBuffer,this._offset,1);this._vF32=new Float32Array(this._arrayBuffer,this._offset+4,1);this._uF32[0]=a||0;this._vF32[0]=b||0};cc.Tex2F.BYTES_PER_ELEMENT=8;_p=cc.Tex2F.prototype;_p._getU=function(){return this._uF32[0]};_p._setU=function(a){this._uF32[0]=a};_p._getV=function(){return this._vF32[0]};_p._setV=function(a){this._vF32[0]=a};
cc.defineGetterSetter(_p,"u",_p._getU,_p._setU);cc.defineGetterSetter(_p,"v",_p._getV,_p._setV);
cc.Quad2=function(a,b,c,d,e,f){this._arrayBuffer=e||new ArrayBuffer(cc.Quad2.BYTES_PER_ELEMENT);this._offset=f||0;e=this._arrayBuffer;f=cc.Vertex2F.BYTES_PER_ELEMENT;this._tl=a?new cc.Vertex2F(a.x,a.y,e,0):new cc.Vertex2F(0,0,e,0);this._tr=b?new cc.Vertex2F(b.x,b.y,e,f):new cc.Vertex2F(0,0,e,f);this._bl=c?new cc.Vertex2F(c.x,c.y,e,2*f):new cc.Vertex2F(0,0,e,2*f);this._br=d?new cc.Vertex2F(d.x,d.y,e,3*f):new cc.Vertex2F(0,0,e,3*f)};cc.Quad2.BYTES_PER_ELEMENT=32;_p=cc.Quad2.prototype;_p._getTL=function(){return this._tl};
_p._setTL=function(a){this._tl.x=a.x;this._tl.y=a.y};_p._getTR=function(){return this._tr};_p._setTR=function(a){this._tr.x=a.x;this._tr.y=a.y};_p._getBL=function(){return this._bl};_p._setBL=function(a){this._bl.x=a.x;this._bl.y=a.y};_p._getBR=function(){return this._br};_p._setBR=function(a){this._br.x=a.x;this._br.y=a.y};cc.defineGetterSetter(_p,"tl",_p._getTL,_p._setTL);cc.defineGetterSetter(_p,"tr",_p._getTR,_p._setTR);cc.defineGetterSetter(_p,"bl",_p._getBL,_p._setBL);
cc.defineGetterSetter(_p,"br",_p._getBR,_p._setBR);cc.Quad3=function(a,b,c,d){this.bl=a||new cc.Vertex3F(0,0,0);this.br=b||new cc.Vertex3F(0,0,0);this.tl=c||new cc.Vertex3F(0,0,0);this.tr=d||new cc.Vertex3F(0,0,0)};
cc.V3F_C4B_T2F=function(a,b,c,d,e){this._arrayBuffer=d||new ArrayBuffer(cc.V3F_C4B_T2F.BYTES_PER_ELEMENT);this._offset=e||0;d=this._arrayBuffer;e=this._offset;var f=cc.Vertex3F.BYTES_PER_ELEMENT;this._vertices=a?new cc.Vertex3F(a.x,a.y,a.z,d,e):new cc.Vertex3F(0,0,0,d,e);this._colors=b?cc.color(b.r,b.g,b.b,b.a,d,e+f):cc.color(0,0,0,0,d,e+f);this._texCoords=c?new cc.Tex2F(c.u,c.v,d,e+f+cc.Color.BYTES_PER_ELEMENT):new cc.Tex2F(0,0,d,e+f+cc.Color.BYTES_PER_ELEMENT)};
cc.V3F_C4B_T2F.BYTES_PER_ELEMENT=24;_p=cc.V3F_C4B_T2F.prototype;_p._getVertices=function(){return this._vertices};_p._setVertices=function(a){var b=this._vertices;b.x=a.x;b.y=a.y;b.z=a.z};_p._getColor=function(){return this._colors};_p._setColor=function(a){var b=this._colors;b.r=a.r;b.g=a.g;b.b=a.b;b.a=a.a};_p._getTexCoords=function(){return this._texCoords};_p._setTexCoords=function(a){this._texCoords.u=a.u;this._texCoords.v=a.v};cc.defineGetterSetter(_p,"vertices",_p._getVertices,_p._setVertices);
...
cc.V2F_C4B_T2F=function(a,b,c,d,e){this._arrayBuffer=d||new ArrayBuffer(cc.V2F_C4B_T2F.BYTES_PER_ELEMENT);this._offset=e||0;d=this._arrayBuffer;e=this._offset;var f=cc.Vertex2F.BYTES_PER_ELEMENT;this._vertices=a?new cc.Vertex2F(a.x,a.y,d,e):new cc.Vertex2F(0,0,d,e);this._colors=b?cc.color(b.r,b.g,b.b,b.a,d,e+f):cc.color(0,0,0,0,d,e+f);this._texCoords=c?new cc.Tex2F(c.u,c.v,d,e+f+cc.Color.BYTES_PER_ELEMENT):new cc.Tex2F(0,0,d,e+f+cc.Color.BYTES_PER_ELEMENT)};cc.V2F_C4B_T2F.BYTES_PER_ELEMENT=20;
_p=cc.V2F_C4B_T2F.prototype;_p._getVertices=function(){return this._vertices};_p._setVertices=function(a){this._vertices.x=a.x;this._vertices.y=a.y};_p._getColor=function(){return this._colors};_p._setColor=function(a){var b=this._colors;b.r=a.r;b.g=a.g;b.b=a.b;b.a=a.a};_p._getTexCoords=function(){return this._texCoords};_p._setTexCoords=function(a){this._texCoords.u=a.u;this._texCoords.v=a.v};cc.defineGetterSetter(_p,"vertices",_p._getVertices,_p._setVertices);
cc.defineGetterSetter(_p,"colors",_p._getColor,_p._setColor);cc.defineGetterSetter(_p,"texCoords",_p._getTexCoords,_p._setTexCoords);
cc.V2F_C4B_T2F_Triangle=function(a,b,c,d,e){this._arrayBuffer=d||new ArrayBuffer(cc.V2F_C4B_T2F_Triangle.BYTES_PER_ELEMENT);this._offset=e||0;d=this._arrayBuffer;e=this._offset;var f=cc.V2F_C4B_T2F.BYTES_PER_ELEMENT;this._a=a?new cc.V2F_C4B_T2F(a.vertices,a.colors,a.texCoords,d,e):new cc.V2F_C4B_T2F(null,null,null,d,e);this._b=b?new cc.V2F_C4B_T2F(b.vertices,b.colors,b.texCoords,d,e+f):new cc.V2F_C4B_T2F(null,null,null,d,e+f);this._c=c?new cc.V2F_C4B_T2F(c.vertices,c.colors,c.texCoords,d,e+2*f):new cc.V2F_C4B_T2F(null,
null,null,d,e+2*f)};cc.V2F_C4B_T2F_Triangle.BYTES_PER_ELEMENT=60;_p=cc.V2F_C4B_T2F_Triangle.prototype;_p._getA=function(){return this._a};_p._setA=function(a){var b=this._a;b.vertices=a.vertices;b.colors=a.colors;b.texCoords=a.texCoords};_p._getB=function(){return this._b};_p._setB=function(a){var b=this._b;b.vertices=a.vertices;b.colors=a.colors;b.texCoords=a.texCoords};_p._getC=function(){return this._c};_p._setC=function(a){var b=this._c;b.vertices=a.vertices;b.colors=a.colors;b.texCoords=a.texCoords};
cc.defineGetterSetter(_p,"a",_p._getA,_p._setA);cc.defineGetterSetter(_p,"b",_p._getB,_p._setB);cc.defineGetterSetter(_p,"c",_p._getC,_p._setC);cc.vertex2=function(a,b){return new cc.Vertex2F(a,b)};cc.vertex3=function(a,b,c){return new cc.Vertex3F(a,b,c)};cc.tex2=function(a,b){return new cc.Tex2F(a,b)};cc.BlendFunc=function(a,b){this.src=a;this.dst=b};cc.blendFuncDisable=function(){return new cc.BlendFunc(cc.ONE,cc.ZERO)};
cc.hexToColor=function(a){a=a.replace(/^#?/,"0x");a=parseInt(a);return cc.color(a>>16,(a>>8)%256,a%256)};cc.colorToHex=function(a){var b=a.r.toString(16),c=a.g.toString(16),d=a.b.toString(16);return"#"+(16>a.r?"0"+b:b)+(16>a.g?"0"+c:c)+(16>a.b?"0"+d:d)};cc.TEXT_ALIGNMENT_LEFT=0;cc.TEXT_ALIGNMENT_CENTER=1;cc.TEXT_ALIGNMENT_RIGHT=2;cc.VERTICAL_TEXT_ALIGNMENT_TOP=0;cc.VERTICAL_TEXT_ALIGNMENT_CENTER=1;cc.VERTICAL_TEXT_ALIGNMENT_BOTTOM=2;
...
cc.size(a,d);this._viewPortRect=cc.rect(0,0,a,d);this._visibleRect=cc.rect(0,0,a,d);this._contentTranslateLeftTop={left:0,top:0};this._viewName="Cocos2dHTML5";a=cc.sys;this.enableRetina(a.os===a.OS_IOS||a.os===a.OS_OSX);this.enableAutoFullScreen(a.isMobile&&a.browserType!==a.BROWSER_TYPE_BAIDU);cc.visibleRect&&cc.visibleRect.init(this._visibleRect);this._rpExactFit=new cc.ResolutionPolicy(b.EQUAL_TO_FRAME,c.EXACT_FIT);this._rpShowAll=new cc.ResolutionPolicy(b.PROPORTION_TO_FRAME,c.SHOW_ALL);this._rpNoBorder=
new cc.ResolutionPolicy(b.EQUAL_TO_FRAME,c.NO_BORDER);this._rpFixedHeight=new cc.ResolutionPolicy(b.EQUAL_TO_FRAME,c.FIXED_HEIGHT);this._rpFixedWidth=new cc.ResolutionPolicy(b.EQUAL_TO_FRAME,c.FIXED_WIDTH);this._hDC=cc._canvas;this._hRC=cc._renderContext;this._targetDensityDPI=cc.DENSITYDPI_HIGH},_resizeEvent:function(){var a;a=this.setDesignResolutionSize?this:cc.view;var b=a._frameSize.width,c=a._frameSize.height;a._initFrameSize();if(a._frameSize.width!==b||a._frameSize.height!==c)a._resizeCallback&&
a._resizeCallback.call(),b=a._originalDesignResolutionSize.width,c=a._originalDesignResolutionSize.height,0<b&&a.setDesignResolutionSize(b,c,a._resolutionPolicy)},setTargetDensityDPI:function(a){this._targetDensityDPI=a;this._adjustViewportMeta()},getTargetDensityDPI:function(){return this._targetDensityDPI},resizeWithBrowserSize:function(a){a?this.__resizeWithBrowserSize||(this.__resizeWithBrowserSize=!0,window.addEventListener("resize",this._resizeEvent),window.addEventListener("orientationchange",
this._resizeEvent)):this.__resizeWithBrowserSize&&(this.__resizeWithBrowserSize=!1,window.removeEventListener("resize",this._resizeEvent),window.removeEventListener("orientationchange",this._resizeEvent))},setResizeCallback:function(a){if(cc.isFunction(a)||null==a)this._resizeCallback=a},_initFrameSize:function(){var a=this._frameSize;a.width=cc.__BrowserGetter.availWidth(this._frame);a.height=cc.__BrowserGetter.availHeight(this._frame)},_adjustSizeKeepCanvasSize:function(){var a=this._originalDesignResolutionSize.width,
b=this._originalDesignResolutionSize.height;0<a&&this.setDesignResolutionSize(a,b,this._resolutionPolicy)},_setViewportMeta:function(a,b){var c=document.getElementById("cocosMetaElement");c&&b&&document.head.removeChild(c);var d=document.getElementsByName("viewport"),d=d?d[0]:null,e,f,g;e=d?d.content:"";c=c||document.createElement("meta");c.id="cocosMetaElement";c.name="viewport";c.content="";for(f in a)-1==e.indexOf(f)?e+=","+f+"\x3d"+a[f]:b&&(g=RegExp(f+"s*\x3ds*[^,]+"),e.replace(g,f+"\x3d"+a[f]));
/^,/.test(e)&&(e=e.substr(1));c.content=e;d&&(d.content=e);document.head.appendChild(c)},_adjustViewportMeta:function(){this._isAdjustViewPort&&(this._setViewportMeta(cc.__BrowserGetter.meta,!1),this._isAdjustViewPort=!1)},_setScaleXYForRenderTexture:function(){var a=cc.contentScaleFactor();this._scaleY=this._scaleX=a},_resetScale:function(){this._scaleX=this._originalScaleX;this._scaleY=this._originalScaleY},_adjustSizeToBrowser:function(){},initialize:function(){this._initialized=!0},adjustViewPort:function(a){this._isAdjustViewPort=
a},enableRetina:function(a){this._retinaEnabled=a?!0:!1},isRetinaEnabled:function(){return this._retinaEnabled},enableAutoFullScreen:function(a){a&&a!==this._autoFullScreen&&cc.sys.isMobile&&this._frame===document.documentElement?(this._autoFullScreen=!0,cc.screen.autoFullScreen(this._frame)):this._autoFullScreen=!1},isAutoFullScreenEnabled:function(){return this._autoFullScreen},end:function(){},isOpenGLReady:function(){return null!==this._hDC&&null!==this._hRC},setFrameZoomFactor:function(a){this._frameZoomFactor=
...
cc.ContainerStrategy=cc.Class.extend({preApply:function(a){},apply:function(a,b){},postApply:function(a){},_setupContainer:function(a,b,c){var d=cc._canvas,e=cc.container;e.style.width=d.style.width=b+"px";e.style.height=d.style.height=c+"px";e=a._devicePixelRatio=1;a.isRetinaEnabled()&&(e=a._devicePixelRatio=Math.min(2,window.devicePixelRatio||1));d.width=b*e;d.height=c*e;cc._renderContext.resetCache&&cc._renderContext.resetCache();a=document.body;var f;a&&(f=a.style)&&(f.paddingTop=f.paddingTop||
"0px",f.paddingRight=f.paddingRight||"0px",f.paddingBottom=f.paddingBottom||"0px",f.paddingLeft=f.paddingLeft||"0px",f.borderTop=f.borderTop||"0px",f.borderRight=f.borderRight||"0px",f.borderBottom=f.borderBottom||"0px",f.borderLeft=f.borderLeft||"0px",f.marginTop=f.marginTop||"0px",f.marginRight=f.marginRight||"0px",f.marginBottom=f.marginBottom||"0px",f.marginLeft=f.marginLeft||"0px")},_fixContainer:function(){document.body.insertBefore(cc.container,document.body.firstChild);var a=document.body.style;
...
this.onKeyPressed&&null===this.onKeyReleased?(cc.log(cc._LogInfos._EventListenerKeyboard_checkAvailable),!1):!0}});cc._EventListenerKeyboard.LISTENER_ID="__cc_keyboard";cc._EventListenerKeyboard.create=function(){return new cc._EventListenerKeyboard};var GlobalVertexBuffer=function(){var a=function(a){this.gl=a;this.vertexBuffer=a.createBuffer();this.size=888;this.byteLength=3552*cc.V3F_C4B_T2F_Quad.BYTES_PER_ELEMENT;this.data=new ArrayBuffer(this.byteLength);this.dataArray=new Float32Array(this.data);a.bindBuffer(a.ARRAY_BUFFER,this.vertexBuffer);a.bufferData(a.ARRAY_BUFFER,this.dataArray,a.DYNAMIC_DRAW);this._dirty=!1;this._spaces={0:this.byteLength}};a.prototype={constructor:a,allocBuffer:function(a,c){var d=this._spaces[a];return d&&d>=c?
(delete this._spaces[a],d>c&&(this._spaces[a+c]=d-c),!0):!1},requestBuffer:function(a){var c,d,e;for(c in this._spaces)if(d=parseInt(c),e=this._spaces[c],e>=a&&this.allocBuffer(d,a))return{buffer:this,offset:d,size:a};return null},freeBuffer:function(a,c){var d=this._spaces,e,f;for(f in d){e=parseInt(f);if(e>a)break;if(e+d[f]>=a){c=c+a-e;a=e;break}}d=a+c;this._spaces[d]&&(c+=this._spaces[d],delete this._spaces[d]);this._spaces[a]=c},setDirty:function(){this._dirty=!0},update:function(){this._dirty&&
(this.gl.bindBuffer(gl.ARRAY_BUFFER,this.vertexBuffer),this.gl.bufferSubData(gl.ARRAY_BUFFER,0,this.dataArray),this._dirty=!1)},destroy:function(){this.gl.deleteBuffer(this.vertexBuffer);this.vertexBuffer=this.texCoords=this.colors=this.positions=this.data=null}};return a}();cc.rendererCanvas={childrenOrderDirty:!0,assignedZ:0,assignedZStep:1E-4,_transformNodePool:[],_renderCmds:[],_isCacheToCanvasOn:!1,_cacheToCanvasCmds:{},_cacheInstanceIds:[],_currentID:0,_clearColor:cc.color(),_clearFillStyle:"rgb(0, 0, 0)",getRenderCmd:function(a){return a._createRenderCmd()},rendering:function(a){var b=this._renderCmds,c,d=cc.view.getScaleX(),e=cc.view.getScaleY(),f=a||cc._renderContext;f.computeRealOffsetY();a=0;for(c=b.length;a<c;a++)b[a].rendering(f,d,e)},_renderingToCacheCanvas:function(a,
b,c,d){a||cc.log("The context of RenderTexture is invalid.");c=cc.isUndefined(c)?1:c;d=cc.isUndefined(d)?1:d;b=b||this._currentID;var e=this._cacheToCanvasCmds[b],f,g;a.computeRealOffsetY();f=0;for(g=e.length;f<g;f++)e[f].rendering(a,c,d);this._removeCache(b);a=this._cacheInstanceIds;0===a.length?this._isCacheToCanvasOn=!1:this._currentID=a[a.length-1]},_turnToCacheMode:function(a){this._isCacheToCanvasOn=!0;a=a||0;this._cacheToCanvasCmds[a]=[];-1===this._cacheInstanceIds.indexOf(a)&&this._cacheInstanceIds.push(a);
...
transformDirty:function(){return 0<this._transformNodePool.length},_sortNodeByLevelAsc:function(a,b){return a._curLevel-b._curLevel},pushDirtyNode:function(a){this._transformNodePool.push(a)},clear:function(){var a=cc._canvas,b=cc._renderContext,c=b.getContext();c.setTransform(1,0,0,1,0,0);c.clearRect(0,0,a.width,a.height);if(0!==this._clearColor.r||0!==this._clearColor.g||0!==this._clearColor.b)b.setFillStyle(this._clearFillStyle),b.setGlobalAlpha(this._clearColor.a),c.fillRect(0,0,a.width,a.height)},
clearRenderCommands:function(){this._renderCmds.length=0;this._cacheInstanceIds.length=0;this._isCacheToCanvasOn=!1},pushRenderCommand:function(a){if(a.needDraw())if(this._isCacheToCanvasOn){var b=this._cacheToCanvasCmds[this._currentID];-1===b.indexOf(a)&&b.push(a)}else-1===this._renderCmds.indexOf(a)&&this._renderCmds.push(a)}};
...
this._context.setTransform(c.a,c.c,c.b,c.d,this._offsetX+c.tx*d,this._realOffsetY-c.ty*e),this.save()):(this._armatureMode--,this.restore())}})();cc.rendererWebGL=function(){function a(a){null===n.buffer&&(n.buffer=cc._renderContext.createBuffer());if(n.maxQuads<a&&n.buffer){var b=cc._renderContext;b.bindBuffer(b.ELEMENT_ARRAY_BUFFER,n.buffer);for(var c=new Uint16Array(6*a),d=0,e=0,f=6*a;e<f;e+=6)c[e]=d+0,c[e+1]=d+1,c[e+2]=d+2,c[e+3]=d+1,c[e+4]=d+2,c[e+5]=d+3,d+=4;b.bufferData(b.ELEMENT_ARRAY_BUFFER,c,b.STATIC_DRAW);n.maxQuads=a}return n.buffer}function b(a,b,c,d,e){var f;e?(f=new Float32Array(e,b,c/4),e=new Uint32Array(e,b,c/4)):(f=new Float32Array(c/
4),e=new Uint32Array(f.buffer));return{buffer:a,float32View:f,uint32View:e,vertexOffset:b,totalBufferSize:c,count:d,valid:!0}}var c=[],d={texture:null,blendSrc:null,blendDst:null,shader:null},e={texture:null,blendSrc:null,blendDst:null,shader:null},f=null,g=new cc.SimplePool,h=!1,k=!1,m=[],n={buffer:null,maxQuads:0};return{mat4Identity:null,childrenOrderDirty:!0,assignedZ:0,assignedZStep:1E-4,_transformNodePool:[],_renderCmds:[],_isCacheToBufferOn:!1,_cacheToBufferCmds:{},_cacheInstanceIds:[],_currentID:0,
_clearColor:cc.color(),init:function(){this.mat4Identity=new cc.math.Matrix4;this.mat4Identity.identity();a(1E3)},requestBuffer:function(a){var b,d=c.length,e,f=cc._renderContext,g;for(b=0;b<d;++b)if(e=c[b],e.gl===f&&(g=e.requestBuffer(a)))return g;g||(e=new GlobalVertexBuffer(f),c.push(e),g=e.requestBuffer(a));g||cc.error("Request WebGL buffer failed");return g},getRenderCmd:function(a){return a._createRenderCmd()},_turnToCacheMode:function(a){this._isCacheToBufferOn=!0;a=a||0;this._cacheToBufferCmds[a]=
[];this._cacheInstanceIds.push(a);this._currentID=a},_turnToNormalMode:function(){this._isCacheToBufferOn=!1},_removeCache:function(a){a=a||this._currentID;var b=this._cacheToBufferCmds[a];b&&(b.length=0,delete this._cacheToBufferCmds[a]);cc.arrayRemoveObject(this._cacheInstanceIds,a)},_renderingToBuffer:function(a){a=a||this._currentID;var b=this._cacheToBufferCmds[a],d,e,f=cc._renderContext;d=0;for(e=c.length;d<e;++d)c[d].update();gl.bindBuffer(gl.ARRAY_BUFFER,null);d=0;for(e=b.length;d<e;d++)b[d].rendering(f);
this._removeCache(a);a=this._cacheInstanceIds;0===a.length?this._isCacheToBufferOn=!1:this._currentID=a[a.length-1]},resetFlag:function(){this.childrenOrderDirty&&(h=!0,this.childrenOrderDirty=!1);this._transformNodePool.length=0},transform:function(){var a=this._transformNodePool;a.sort(this._sortNodeByLevelAsc);var b,c,d;b=0;for(c=a.length;b<c;b++)d=a[b],d.updateStatus();a.length=0},transformDirty:function(){return 0<this._transformNodePool.length},_sortNodeByLevelAsc:function(a,b){return a._curLevel-
b._curLevel},pushDirtyNode:function(a){this._transformNodePool.push(a)},clearRenderCommands:function(){var a=this._renderCmds,b,c=a.length,d;for(b=0;b<c;++b)d=a[b],d._currId=-1,m[b]=d;m.length=c;this._renderCmds.length=0},clear:function(){var a=cc._renderContext;a.clearColor(this._clearColor.r,this._clearColor.g,this._clearColor.b,this._clearColor.a);a.clear(a.COLOR_BUFFER_BIT|a.DEPTH_BUFFER_BIT)},setDepthTest:function(a){var b=cc._renderContext;a?(b.clearDepth(1),b.enable(b.DEPTH_TEST),b.depthFunc(b.LEQUAL)):
b.disable(b.DEPTH_TEST)},pushRenderCommand:function(a){if(a.needDraw())if(this._isCacheToBufferOn){var b=this._cacheToBufferCmds[this._currentID];-1===b.indexOf(a)&&b.push(a)}else-1===this._renderCmds.indexOf(a)&&(a._currId=this._renderCmds.length,this._renderCmds.push(a))},createBatchBuffer:function(a){var b=gl.createBuffer();this.initBatchBuffers(b,a);return{arrayBuffer:b,bufferSize:a}},initBatchBuffers:function(a,b){gl.bindBuffer(gl.ARRAY_BUFFER,a);gl.bufferData(gl.ARRAY_BUFFER,b,gl.DYNAMIC_DRAW)},
getBatchBuffer:function(a){if(0<g.size()){var b=Number.MAX_VALUE,c=-1,d=g.find(function(d,e){if(e.bufferSize>=a)return!0;e.bufferSize<b&&(b=e.bufferSize,c=d)},function(){return c});if(d)return this.initBatchBuffers(d.arrayBuffer,a),d.bufferSize=a,d}return this.createBatchBuffer(a)},_refreshVirtualBuffers:function(){for(var a=this._renderCmds,c=m.length,f=a.length,g=0,h=0,n,y,v,w;g<c;++g)if(n=m[g],v=n._vBuffer,matched=!1,v&&v.valid)if(h=n._currId,0>h||h>=f)n._vBuffer=null;else{n.getBatchInfo(d);w=
0;for(y=a[h];n&&n===y&&n._vBuffer===v;)++w,++h,n=m[g+w],y=a[h];h=g+w;if(1>=w)n=m[g],n._vBuffer=null,y&&(y._vBuffer=null);else{if(y&&y._supportBatch&&(y.getBatchInfo(e),e.texture===d.texture&&e.blendSrc===d.blendSrc&&e.blendDst===d.blendDst&&e.shader===d.shader)){for(;g<h;++g)m[g]._vBuffer=null;g--;continue}if(v.count===w)g=g+w-1;else if(1<w){n=m[g];y=w*n.bytesPerUnit;for(n=b(v.buffer,4*n._vertexOffset,y,w,v.float32View.buffer);g<h;++g)m[g]._vBuffer=n;g--}}}c=a.length;for(g=0;g<c;++g)n=a[g],n._vBuffer||
(f=a[g+1],n._supportBatch&&f&&f._supportBatch&&(w=this._forwardBatch(g),1<w&&(g+=w-1)));m.length=0;k=!1},_forwardCheck:function(a){var b=this._renderCmds,c=b[a],e=a,g=b.length,h=c._vBuffer;c.getBatchInfo(d);f=null;if(c._vertexOffset!==h.vertexOffset||!h.valid||!h.buffer)return k=!0,0;for(var m;e<g;++e){c=b[e];if(h!==c._vBuffer)break;c._bufferDirty&&(m||(m=h,gl.bindBuffer(gl.ARRAY_BUFFER,m.buffer.arrayBuffer)),c.batchVertexBuffer(m.float32View,m.uint32View,c._vertexOffset),c._bufferDirty=!1)}m&&gl.bufferSubData(gl.ARRAY_BUFFER,
0,m.float32View);g=e-a;if(h.count===g)return f=h,g;for(e=a;e<a+g;++e)c=b[e],c._vBuffer=null;k=!0;return 0},_forwardBatch:function(a){var c=this._renderCmds,g=c[a],h=a+1;if(!g||!g._supportBatch)return 0;g.getBatchInfo(d);if(!d.texture)return 0;for(var k=g.bytesPerUnit,g=c[h];g;){if(g._supportBatch)g.getBatchInfo(e);else break;if(e.texture!==d.texture||e.blendSrc!==d.blendSrc||e.blendDst!==d.blendDst||e.shader!==d.shader)break;else k+=g.bytesPerUnit;++h;g=c[h]}var m=h-a;if(1>=m)return m;g=this.getBatchBuffer(k);
f=k=b(g,0,k,m);var n=k.float32View,v=0;for(gl.bindBuffer(gl.ARRAY_BUFFER,k.buffer.arrayBuffer);a<h;++a)g=c[a],g.batchVertexBuffer(n,k.uint32View,v),g._vBuffer=k,g._vertexOffset=v,g._savedDirtyFlag&&(g._savedDirtyFlag=!1),v+=g.vertexBytesPerUnit/4;gl.bufferSubData(gl.ARRAY_BUFFER,0,n);return m},_batchRendering:function(){var b=d.texture,c=d.shader,e=f.count;c.use();c._updateProjectionUniform();cc.glBlendFunc(d.blendSrc,d.blendDst);cc.glBindTexture2DN(0,b);gl.bindBuffer(gl.ARRAY_BUFFER,f.buffer.arrayBuffer);
gl.enableVertexAttribArray(cc.VERTEX_ATTRIB_POSITION);gl.enableVertexAttribArray(cc.VERTEX_ATTRIB_COLOR);gl.enableVertexAttribArray(cc.VERTEX_ATTRIB_TEX_COORDS);b=f.vertexOffset;gl.vertexAttribPointer(cc.VERTEX_ATTRIB_POSITION,3,gl.FLOAT,!1,24,b);gl.vertexAttribPointer(cc.VERTEX_ATTRIB_COLOR,4,gl.UNSIGNED_BYTE,!0,24,b+12);gl.vertexAttribPointer(cc.VERTEX_ATTRIB_TEX_COORDS,2,gl.FLOAT,!1,24,b+16);b=a(e);gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER,b);gl.drawElements(gl.TRIANGLES,6*e,gl.UNSIGNED_SHORT,0);cc.g_NumberOfDraws++},
rendering:function(a){var b=this._renderCmds,d,e,f,g=a||cc._renderContext;a=0;for(d=c.length;a<d;++a)c[a].update();(h||k)&&this._refreshVirtualBuffers();g.bindBuffer(gl.ARRAY_BUFFER,null);a=0;for(d=b.length;a<d;++a){e=b[a];if(e._vBuffer&&(f=this._forwardCheck(a),1<f)){this._batchRendering();a+=f-1;continue}e.rendering(g)}h&&(h=!1)}}}();cc._tmp.PrototypeCCNode=function(){var a=cc.Node.prototype;cc.defineGetterSetter(a,"x",a.getPositionX,a.setPositionX);cc.defineGetterSetter(a,"y",a.getPositionY,a.setPositionY);cc.defineGetterSetter(a,"width",a._getWidth,a._setWidth);cc.defineGetterSetter(a,"height",a._getHeight,a._setHeight);cc.defineGetterSetter(a,"anchorX",a._getAnchorX,a._setAnchorX);cc.defineGetterSetter(a,"anchorY",a._getAnchorY,a._setAnchorY);cc.defineGetterSetter(a,"skewX",a.getSkewX,a.setSkewX);cc.defineGetterSetter(a,"skewY",
...
_setLocalZOrder:function(a){this._localZOrder=a},getLocalZOrder:function(){return this._localZOrder},getZOrder:function(){cc.log(cc._LogInfos.Node_getZOrder);return this.getLocalZOrder()},setZOrder:function(a){cc.log(cc._LogInfos.Node_setZOrder);this.setLocalZOrder(a)},setGlobalZOrder:function(a){this._globalZOrder!==a&&(this._globalZOrder=a,cc.eventManager._setDirtyForNode(this))},getGlobalZOrder:function(){return this._globalZOrder},getVertexZ:function(){return this._vertexZ},setVertexZ:function(a){this._customZ=
this._vertexZ=a},getRotation:function(){this._rotationX!==this._rotationY&&cc.log(cc._LogInfos.Node_getRotation);return this._rotationX},setRotation:function(a){this._rotationX=this._rotationY=a;this._renderCmd.setDirtyFlag(cc.Node._dirtyFlags.transformDirty)},getRotationX:function(){return this._rotationX},setRotationX:function(a){this._rotationX=a;this._renderCmd.setDirtyFlag(cc.Node._dirtyFlags.transformDirty)},getRotationY:function(){return this._rotationY},setRotationY:function(a){this._rotationY=
a;this._renderCmd.setDirtyFlag(cc.Node._dirtyFlags.transformDirty)},getScale:function(){this._scaleX!==this._scaleY&&cc.log(cc._LogInfos.Node_getScale);return this._scaleX},setScale:function(a,b){this._scaleX=a;this._scaleY=b||0===b?b:a;this._renderCmd.setDirtyFlag(cc.Node._dirtyFlags.transformDirty)},getScaleX:function(){return this._scaleX},setScaleX:function(a){this._scaleX=a;this._renderCmd.setDirtyFlag(cc.Node._dirtyFlags.transformDirty)},getScaleY:function(){return this._scaleY},setScaleY:function(a){this._scaleY=
a;this._renderCmd.setDirtyFlag(cc.Node._dirtyFlags.transformDirty)},setPosition:function(a,b){var c=this._position;if(void 0===b){if(c.x===a.x&&c.y===a.y)return;c.x=a.x;c.y=a.y}else{if(c.x===a&&c.y===b)return;c.x=a;c.y=b}this._usingNormalizedPosition=!1;this._renderCmd.setDirtyFlag(cc.Node._dirtyFlags.transformDirty)},setNormalizedPosition:function(a,b){var c=this._normalizedPosition;void 0===b?(c.x=a.x,c.y=a.y):(c.x=a,c.y=b);this._normalizedPositionDirty=this._usingNormalizedPosition=!0;this._renderCmd.setDirtyFlag(cc.Node._dirtyFlags.transformDirty)},
getPosition:function(){return cc.p(this._position)},getNormalizedPosition:function(){return cc.p(this._normalizedPosition)},getPositionX:function(){return this._position.x},setPositionX:function(a){this._position.x=a;this._renderCmd.setDirtyFlag(cc.Node._dirtyFlags.transformDirty)},getPositionY:function(){return this._position.y},setPositionY:function(a){this._position.y=a;this._renderCmd.setDirtyFlag(cc.Node._dirtyFlags.transformDirty)},getChildrenCount:function(){return this._children.length},getChildren:function(){return this._children},
isVisible:function(){return this._visible},setVisible:function(a){this._visible!==a&&(this._visible=a,this._renderCmd.setDirtyFlag(cc.Node._dirtyFlags.transformDirty),cc.renderer.childrenOrderDirty=!0)},getAnchorPoint:function(){return cc.p(this._anchorPoint)},setAnchorPoint:function(a,b){var c=this._anchorPoint;if(void 0===b){if(a.x===c.x&&a.y===c.y)return;c.x=a.x;c.y=a.y}else{if(a===c.x&&b===c.y)return;c.x=a;c.y=b}this._renderCmd._updateAnchorPointInPoint()},_getAnchorX:function(){return this._anchorPoint.x},
_setAnchorX:function(a){this._anchorPoint.x!==a&&(this._anchorPoint.x=a,this._renderCmd._updateAnchorPointInPoint())},_getAnchorY:function(){return this._anchorPoint.y},_setAnchorY:function(a){this._anchorPoint.y!==a&&(this._anchorPoint.y=a,this._renderCmd._updateAnchorPointInPoint())},getAnchorPointInPoints:function(){return this._renderCmd.getAnchorPointInPoints()},_getWidth:function(){return this._contentSize.width},_setWidth:function(a){this._contentSize.width=a;this._renderCmd._updateAnchorPointInPoint()},
_getHeight:function(){return this._contentSize.height},_setHeight:function(a){this._contentSize.height=a;this._renderCmd._updateAnchorPointInPoint()},getContentSize:function(){return cc.size(this._contentSize)},setContentSize:function(a,b){var c=this._contentSize;if(void 0===b){if(a.width===c.width&&a.height===c.height)return;c.width=a.width;c.height=a.height}else{if(a===c.width&&b===c.height)return;c.width=a;c.height=b}this._renderCmd._updateAnchorPointInPoint()},isRunning:function(){return this._running},
...
a.enableVertexAttribArray(cc.VERTEX_ATTRIB_POSITION);a.enableVertexAttribArray(cc.VERTEX_ATTRIB_COLOR);cc.glBlendFunc(c._blendFunc.src,c._blendFunc.dst);a.bindBuffer(a.ARRAY_BUFFER,this._verticesFloat32Buffer);a.vertexAttribPointer(cc.VERTEX_ATTRIB_POSITION,2,a.FLOAT,!1,0,0);a.bindBuffer(a.ARRAY_BUFFER,this._colorsUint8Buffer);a.vertexAttribPointer(cc.VERTEX_ATTRIB_COLOR,4,a.UNSIGNED_BYTE,!0,0,0);a.drawArrays(a.TRIANGLE_STRIP,0,this._squareVertices.length);a.disable(a.SCISSOR_TEST)};a._getClippingRect=
...
cc.p(0,0);this._blendFunc={src:cc.BLEND_SRC,dst:cc.BLEND_DST};this._rect=cc.rect(0,0,0,0);this._softInit(a,b,c)},onEnter:function(){this._super();cc._renderType===cc.game.RENDER_TYPE_WEBGL&&this._renderCmd.updateBuffer()},cleanup:function(){cc._renderType===cc.game.RENDER_TYPE_WEBGL&&this._renderCmd.freeBuffer();this._super()},textureLoaded:function(){return this._textureLoaded},addLoadedEventListener:function(a,b){this.addEventListener("load",a,b)},isDirty:function(){return this.dirty},setDirty:function(a){this.dirty=
a},isTextureRectRotated:function(){return this._rectRotated},getAtlasIndex:function(){return this.atlasIndex},setAtlasIndex:function(a){this.atlasIndex=a},getTextureRect:function(){return cc.rect(this._rect)},getTextureAtlas:function(){return this.textureAtlas},setTextureAtlas:function(a){this.textureAtlas=a},getOffsetPosition:function(){return cc.p(this._offsetPosition)},_getOffsetX:function(){return this._offsetPosition.x},_getOffsetY:function(){return this._offsetPosition.y},getBlendFunc:function(){return this._blendFunc},
initWithSpriteFrame:function(a){cc.assert(a,cc._LogInfos.Sprite_initWithSpriteFrame);a.textureLoaded()||(this._textureLoaded=!1,a.addEventListener("load",this._renderCmd._spriteFrameLoadedCallback,this));var b=cc._renderType===cc.game.RENDER_TYPE_CANVAS?!1:a._rotated,b=this.initWithTexture(a.getTexture(),a.getRect(),b);this.setSpriteFrame(a);return b},initWithSpriteFrameName:function(a){cc.assert(a,cc._LogInfos.Sprite_initWithSpriteFrameName);var b=cc.spriteFrameCache.getSpriteFrame(a);cc.assert(b,
a+cc._LogInfos.Sprite_initWithSpriteFrameName1);return this.initWithSpriteFrame(b)},useBatchNode:function(a){this.textureAtlas=a.getTextureAtlas();this._batchNode=a},setVertexRect:function(a){var b=this._rect;b.x=a.x;b.y=a.y;b.width=a.width;b.height=a.height},sortAllChildren:function(){if(this._reorderChildDirty){var a=this._children;cc.Node.prototype.sortAllChildren.call(this);this._batchNode&&this._arrayMakeObjectsPerformSelector(a,cc.Node._stateCallbackType.sortAllChildren);this._reorderChildDirty=
!1}},reorderChild:function(a,b){cc.assert(a,cc._LogInfos.Sprite_reorderChild_2);-1===this._children.indexOf(a)?cc.log(cc._LogInfos.Sprite_reorderChild):b!==a.zIndex&&(this._batchNode&&!this._reorderChildDirty&&(this._setReorderChildDirtyRecursively(),this._batchNode.reorderBatch(!0)),cc.Node.prototype.reorderChild.call(this,a,b))},removeChild:function(a,b){this._batchNode&&this._batchNode.removeSpriteFromAtlas(a);cc.Node.prototype.removeChild.call(this,a,b)},setVisible:function(a){cc.Node.prototype.setVisible.call(this,
a);this._renderCmd.setDirtyRecursively(!0)},removeAllChildren:function(a){var b=this._children,c=this._batchNode;if(c&&null!=b)for(var d=0,e=b.length;d<e;d++)c.removeSpriteFromAtlas(b[d]);cc.Node.prototype.removeAllChildren.call(this,a);this._hasChildren=!1},ignoreAnchorPointForPosition:function(a){this._batchNode?cc.log(cc._LogInfos.Sprite_ignoreAnchorPointForPosition):cc.Node.prototype.ignoreAnchorPointForPosition.call(this,a)},setFlippedX:function(a){this._flippedX!==a&&(this._flippedX=a,this.setTextureRect(this._rect,
...
-1));var r,t,u;this._colorized?r=g=0:(g=f.renderX,r=f.renderY);t=f.width;u=f.height;m*=c;s*=d;p*=c;n*=d;h&&h._htmlElementObj?(c=h._htmlElementObj,""!==h._pattern?(a.setFillStyle(k.createPattern(c,h._pattern)),k.fillRect(m,s,p,n)):k.drawImage(c,g,r,t,u,m,s,p,n)):(h=e._contentSize,f.validRect&&(f=this._displayedColor,a.setFillStyle("rgba("+f.r+","+f.g+","+f.b+",1)"),k.fillRect(m,s,h.width*c,h.height*d)));(e._flippedX||e._flippedY)&&a.restore();cc.g_NumberOfDraws++}};a._updateColor=function(){var a=
this._node._texture,c=this._textureCoord,d=this._displayedColor;a&&(255!==d.r||255!==d.g||255!==d.b?(this._textureToRender=a._generateColorTexture(d.r,d.g,d.b,c),this._colorized=!0):a&&(this._textureToRender=a,this._colorized=!1))};a.getQuad=function(){return null};a._updateForSetSpriteFrame=function(a,c){this._colorized=!1;this._textureCoord.renderX=this._textureCoord.x;this._textureCoord.renderY=this._textureCoord.y;if(c=c||a._textureLoaded){var d=this._node.getColor();255===d.r&&255===d.g&&255===
d.b||this._updateColor()}};a.updateTransform=function(){var a=this._node;if(a.dirty){var c=a._parent;!a._visible||c&&c!==a._batchNode&&c._shouldBeHidden?a._shouldBeHidden=!0:(a._shouldBeHidden=!1,a._transformToBatch=c&&c!==a._batchNode?cc.affineTransformConcat(this.getNodeToParentTransform(),c._transformToBatch):this.getNodeToParentTransform());a._recursiveDirty=!1;a.dirty=!1}a._hasChildren&&a._arrayMakeObjectsPerformSelector(a._children,cc.Node._stateCallbackType.updateTransform)};a._spriteFrameLoadedCallback=
function(a){this.setTextureRect(a.getRect(),a.isRotated(),a.getOriginalSize());this._renderCmd._updateColor();this.dispatchEvent("load")};a._textureLoadedCallback=function(a){if(!this._textureLoaded){this._textureLoaded=!0;var c=this._rect,d=this._renderCmd;c?cc._rectEqualToZero(c)&&(c.width=a.width,c.height=a.height):c=cc.rect(0,0,a.width,a.height);this.texture=a;this.setTextureRect(c,this._rectRotated);a=d._displayedColor;255===a.r&&255===a.g&&255===a.b||d._updateColor();this.setBatchNode(this._batchNode);
this.dispatchEvent("load")}};a._setTextureCoords=function(a,c){void 0===c&&(c=!0);var d=this._textureCoord,e=c?cc.contentScaleFactor():1;d.renderX=d.x=0|a.x*e;d.renderY=d.y=0|a.y*e;d.width=0|a.width*e;d.height=0|a.height*e;d.validRect=!(0===d.width||0===d.height||0>d.x||0>d.y)};cc.Sprite.CanvasRenderCmd._cutRotateImageToCanvas=function(a,c,d){if(!a)return null;if(!c)return a;d=null==d?!0:d;var e=document.createElement("canvas");e.width=c.width;e.height=c.height;var f=e.getContext("2d");f.translate(e.width/
2,e.height/2);d?f.rotate(-1.5707963267948966):f.rotate(1.5707963267948966);f.drawImage(a,c.x,c.y,c.height,c.width,-c.height/2,-c.width/2,c.height,c.width);return e}})();(function(){var a=!0;cc.Sprite.WebGLRenderCmd=function(a){cc.Node.WebGLRenderCmd.call(this,a);this._needDraw=!0;this._vertices=[{x:0,y:0,z:0},{x:0,y:0,z:0},{x:0,y:0,z:0},{x:0,y:0,z:0}];a=this.vertexBytesPerUnit;var d=cc.renderer.requestBuffer(a);this._buffer=d.buffer;this._bufferOffset=d.offset;this._quad=new cc.V3F_C4B_T2F_Quad(null,null,null,null,this._buffer.data,this._bufferOffset);this._float32View=new Float32Array(this._buffer.data,this._bufferOffset,a/4);this._uint32View=new Uint32Array(this._buffer.data,
this._bufferOffset,a/4);this._recursiveDirty=this._bufferDirty=this._dirty=!1;this._vBuffer=null;this._vertexOffset=0;b.batchShader||(b.batchShader=cc.shaderCache.programForKey(cc.SHADER_SPRITE_POSITION_TEXTURECOLORALPHATEST))};var b=cc.Sprite.WebGLRenderCmd.prototype=Object.create(cc.Node.WebGLRenderCmd.prototype);b.constructor=cc.Sprite.WebGLRenderCmd;b.vertexBytesPerUnit=cc.V3F_C4B_T2F_Quad.BYTES_PER_ELEMENT;b.bytesPerUnit=b.vertexBytesPerUnit;b.indicesPerUnit=6;b.verticesPerUnit=4;b._supportBatch=
!0;b.batchShader=null;b.getBatchInfo=function(a){a.texture=this._node._texture;a.blendSrc=this._node._blendFunc.src;a.blendDst=this._node._blendFunc.dst;a.shader=this.batchShader};b._invalidBatch=function(){this._vBuffer&&(this._vBuffer.valid=!1)};b.updateBuffer=function(){if(!this._buffer){var a=this.vertexBytesPerUnit,b=cc.renderer.requestBuffer(a);this._buffer=b.buffer;this._bufferOffset=b.offset;this._quad=new cc.V3F_C4B_T2F_Quad(null,null,null,null,this._buffer.data,this._bufferOffset);this._float32View=
new Float32Array(this._quad.arrayBuffer,this._bufferOffset,a/4);this._uint32View=new Uint32Array(this._quad.arrayBuffer,this._bufferOffset,a/4);this._setTextureCoords(this._node._rect);this._updateColor();this._updateVertexBuffer()}};b.freeBuffer=function(){this._buffer&&(this._buffer.freeBuffer(this._bufferOffset,this.vertexBytesPerUnit),this._buffer=null,this._bufferOffset=0,this._float32View=this._quad=null)};b.updateBlendFunc=function(a){};b.setDirtyFlag=function(a){cc.Node.WebGLRenderCmd.prototype.setDirtyFlag.call(this,
a);this._dirty=!0};b.setDirtyRecursively=function(a){this._dirty=this._recursiveDirty=a;for(var b=this._node._children,e,f=b?b.length:0,g=0;g<f;g++)e=b[g],e instanceof cc.Sprite&&e._renderCmd.setDirtyRecursively(a)};b._setBatchNodeForAddChild=function(a){var b=this._node;if(b._batchNode){if(!(a instanceof cc.Sprite))return cc.log(cc._LogInfos.Sprite_addChild),!1;a.texture._webTextureObj!==b.textureAtlas.texture._webTextureObj&&cc.log(cc._LogInfos.Sprite_addChild_2);b._batchNode.appendChild(a);b._reorderChildDirty||
b._setReorderChildDirtyRecursively()}return!0};b._handleTextureForRotatedTexture=function(a){return a};b.isFrameDisplayed=function(a){var b=this._node;return cc.rectEqualToRect(a.getRect(),b._rect)&&a.getTexture().getName()===b._texture.getName()&&cc.pointEqualToPoint(a.getOffset(),b._unflippedOffsetPositionFromCenter)};b._init=function(){this.updateBuffer();var a={r:255,g:255,b:255,a:255},b=this._quad;b.bl.colors=a;b.br.colors=a;b.tl.colors=a;b.tr.colors=a;this._bufferDirty=!0;this._buffer.setDirty()};
b._resetForBatchNode=function(){var a=this._node,b=a._offsetPosition.x,e=a._offsetPosition.y,f=b+a._rect.width,a=e+a._rect.height,g=this._vertices;g[0].x=b;g[0].y=a;g[1].x=b;g[1].y=e;g[2].x=f;g[2].y=a;g[3].x=f;g[3].y=e;this._bufferDirty=!0;this._buffer&&this._buffer.setDirty()};b.getQuad=function(){return this._quad};b._updateForSetSpriteFrame=function(){};b._spriteFrameLoadedCallback=function(a){this.setTextureRect(a.getRect(),a.isRotated(),a.getOriginalSize());this.dispatchEvent("load")};b._textureLoadedCallback=
function(a){if(!this._textureLoaded){this._textureLoaded=!0;var b=this._rect;b?cc._rectEqualToZero(b)&&(b.width=a.width,b.height=a.height):b=cc.rect(0,0,a.width,a.height);this.texture=a;this.setTextureRect(b,this._rectRotated);this.setBatchNode(this._batchNode);this.dispatchEvent("load")}};b._setTextureCoords=function(a,b){void 0===b&&(b=!0);b&&(a=cc.rectPointsToPixels(a));var e=this._node,f=this._quad,g=e._batchNode?e.textureAtlas.texture:e._texture;if(g&&f){var h=g.pixelsWidth,k=g.pixelsHeight,
m,n;e._rectRotated?(cc.FIX_ARTIFACTS_BY_STRECHING_TEXEL?(g=(2*a.x+1)/(2*h),h=g+(2*a.height-2)/(2*h),m=(2*a.y+1)/(2*k),k=m+(2*a.width-2)/(2*k)):(g=a.x/h,h=(a.x+a.height)/h,m=a.y/k,k=(a.y+a.width)/k),e._flippedX&&(n=m,m=k,k=n),e._flippedY&&(n=g,g=h,h=n),f.bl.texCoords.u=g,f.bl.texCoords.v=m,f.br.texCoords.u=g,f.br.texCoords.v=k,f.tl.texCoords.u=h,f.tl.texCoords.v=m,f.tr.texCoords.u=h,f.tr.texCoords.v=k):(cc.FIX_ARTIFACTS_BY_STRECHING_TEXEL?(g=(2*a.x+1)/(2*h),h=g+(2*a.width-2)/(2*h),m=(2*a.y+1)/(2*k),
k=m+(2*a.height-2)/(2*k)):(g=a.x/h,h=(a.x+a.width)/h,m=a.y/k,k=(a.y+a.height)/k),e._flippedX&&(n=g,g=h,h=n),e._flippedY&&(n=m,m=k,k=n),f.bl.texCoords.u=g,f.bl.texCoords.v=k,f.br.texCoords.u=h,f.br.texCoords.v=k,f.tl.texCoords.u=g,f.tl.texCoords.v=m,f.tr.texCoords.u=h,f.tr.texCoords.v=m);this._bufferDirty=!0;this._buffer.setDirty()}};b._updateVertexBuffer=function(){if(this._buffer){var a=this._stackMatrix.mat,b=this._vertices,e=this._float32View,f,g,h,k=0,m=cc.V3F_C4B_T2F_Quad.BYTES_PER_ELEMENT/16;
for(f=0;4>f;++f)g=b[f].x,h=b[f].y,e[k]=g*a[0]+h*a[4]+a[12],e[k+1]=g*a[1]+h*a[5]+a[13],e[k+2]=a[14],k+=m;this._bufferDirty=!0;this._buffer.setDirty()}};b.transform=function(a,b){cc.Node.WebGLRenderCmd.prototype.transform.call(this,a,b);this._updateVertexBuffer();this._savedDirtyFlag=this._dirty=!0};b._setColorDirty=function(){};b._updateColor=function(){var a=this._displayedColor,b=this._displayedOpacity,e=this._node,a={r:a.r,g:a.g,b:a.b,a:b};e._opacityModifyRGB&&(a.r*=b/255,a.g*=b/255,a.b*=b/255);
if(b=this._quad)b.bl.colors=a,b.br.colors=a,b.tl.colors=a,b.tr.colors=a,this._buffer.setDirty();e._batchNode&&(e.atlasIndex!==cc.Sprite.INDEX_NOT_INITIALIZED?e.textureAtlas.updateQuad(b,e.atlasIndex):this._dirty=!0);this._bufferDirty=!0};b._updateBlendFunc=function(){if(this._batchNode)cc.log(cc._LogInfos.Sprite__updateBlendFunc);else{var a=this._node,b=a._blendFunc;a._texture&&a._texture.hasPremultipliedAlpha()?(b.src===cc.SRC_ALPHA&&b.dst===cc.BLEND_DST&&(b.src=cc.ONE),a.opacityModifyRGB=!0):(b.src===
cc.ONE&&b.dst===cc.BLEND_DST&&(b.src=cc.SRC_ALPHA),a.opacityModifyRGB=!1);this._invalidBatch()}};b._setTexture=function(a){var b=this._node;if(b._batchNode){if(b._batchNode.texture!==a){cc.log(cc._LogInfos.Sprite_setTexture);return}}else b._texture!==a&&(b._textureLoaded=a?a._textureLoaded:!1,b._texture=a,this._updateBlendFunc());this._shaderProgram=a?cc.shaderCache.programForKey(cc.SHADER_SPRITE_POSITION_TEXTURECOLORALPHATEST):cc.shaderCache.programForKey(cc.SHADER_SPRITE_POSITION_COLOR)};b.updateTransform=
function(){var a=this._node;if(this._dirty){var b=this._quad,e=a._parent;if(!a._visible||e&&e!==a._batchNode&&e._shouldBeHidden)b.br.vertices=b.tl.vertices=b.tr.vertices=b.bl.vertices={x:0,y:0,z:0},a._shouldBeHidden=!0;else{a._shouldBeHidden=!1;0!==this._dirtyFlag&&(this.updateStatus(),this._dirtyFlag=0);a._transformToBatch=e&&e!==a._batchNode?cc.affineTransformConcat(this.getNodeToParentTransform(),e._transformToBatch):this.getNodeToParentTransform();var f=a._transformToBatch,g=a._rect,e=a._offsetPosition.x,
h=a._offsetPosition.y,k=e+g.width,m=h+g.height,n=f.tx,p=f.ty,s=f.a,r=f.b,t=f.d,u=-f.c,f=e*s-h*u+n,g=e*r+h*t+p,z=k*s-h*u+n,h=k*r+h*t+p,y=k*s-m*u+n,k=k*r+m*t+p,n=e*s-m*u+n,e=e*r+m*t+p,m=a._vertexZ;cc.SPRITEBATCHNODE_RENDER_SUBPIXEL||(f|=0,g|=0,z|=0,h|=0,y|=0,k|=0,n|=0,e|=0);b.bl.vertices={x:f,y:g,z:m};b.br.vertices={x:z,y:h,z:m};b.tl.vertices={x:n,y:e,z:m};b.tr.vertices={x:y,y:k,z:m}}a.textureAtlas.updateQuad(b,a.atlasIndex);this._dirty=a._recursiveDirty=!1}a._hasChildren&&a._arrayMakeObjectsPerformSelector(a._children,
cc.Node._stateCallbackType.updateTransform)};b._checkTextureBoundary=function(a,b,e){a&&a.url&&(e?(e=b.x+b.height,b=b.y+b.width):(e=b.x+b.width,b=b.y+b.height),e>a.width&&cc.error(cc._LogInfos.RectWidth,a.url),b>a.height&&cc.error(cc._LogInfos.RectHeight,a.url))};b.needDraw=function(){return this._buffer&&this._needDraw};b.rendering=function(b){var d=this._node,e=d._texture;if(this._buffer&&(!e||e._textureLoaded&&d._rect.width&&d._rect.height)&&this._displayedOpacity){b=b||cc._renderContext;var f=
this._shaderProgram;if(e){if(e._textureLoaded){f.use();f._updateProjectionUniform();cc.glBlendFunc(d._blendFunc.src,d._blendFunc.dst);cc.glBindTexture2DN(0,e);e=!b.bindBuffer(b.ARRAY_BUFFER,this._buffer.vertexBuffer);if(a||e)b.enableVertexAttribArray(cc.VERTEX_ATTRIB_POSITION),b.enableVertexAttribArray(cc.VERTEX_ATTRIB_COLOR),b.enableVertexAttribArray(cc.VERTEX_ATTRIB_TEX_COORDS),b.vertexAttribPointer(cc.VERTEX_ATTRIB_POSITION,3,b.FLOAT,!1,24,0),b.vertexAttribPointer(cc.VERTEX_ATTRIB_COLOR,4,b.UNSIGNED_BYTE,
!0,24,12),b.vertexAttribPointer(cc.VERTEX_ATTRIB_TEX_COORDS,2,b.FLOAT,!1,24,16),a=!1;b.drawArrays(b.TRIANGLE_STRIP,this._bufferOffset/(this.vertexBytesPerUnit/4),4)}}else f.use(),f._updateProjectionUniform(),cc.glBlendFunc(d._blendFunc.src,d._blendFunc.dst),b.bindBuffer(b.ARRAY_BUFFER,this._buffer.vertexBuffer),b.enableVertexAttribArray(cc.VERTEX_ATTRIB_POSITION),b.enableVertexAttribArray(cc.VERTEX_ATTRIB_COLOR),b.vertexAttribPointer(cc.VERTEX_ATTRIB_POSITION,3,b.FLOAT,!1,24,0),b.vertexAttribPointer(cc.VERTEX_ATTRIB_COLOR,
4,b.UNSIGNED_BYTE,!0,24,12),b.drawArrays(b.TRIANGLE_STRIP,this._bufferOffset/(this.vertexBytesPerUnit/4),4),a=!0;cc.g_NumberOfDraws++;if(0!==cc.SPRITE_DEBUG_DRAW||d._showNode)cc.kmGLMatrixMode(cc.KM_GL_MODELVIEW),cc.current_stack.stack.push(cc.current_stack.top),cc.current_stack.top=this._stackMatrix,1===cc.SPRITE_DEBUG_DRAW||d._showNode?(d=this._vertices,d=[cc.p(d[0].x,d[0].y),cc.p(d[2].x,d[2].y),cc.p(d[3].x,d[3].y),cc.p(d[1].x,d[1].y)],cc._drawingUtil.drawPoly(d,4,!0)):2===cc.SPRITE_DEBUG_DRAW&&
(e=d.getTextureRect(),d=d.getOffsetPosition(),d=[cc.p(d.x,d.y),cc.p(d.x+e.width,d.y),cc.p(d.x+e.width,d.y+e.height),cc.p(d.x,d.y+e.height)],cc._drawingUtil.drawPoly(d,4,!0)),cc.current_stack.top=cc.current_stack.stack.pop()}};b.batchVertexBuffer=function(a,b,e){var f=this._float32View,g=this._uint32View,h,k=f.length,m=3;for(h=0;h<k;++h)h===m?(b[e+h]=g[h],m+=6):a[e+h]=f[h]}})();cc.SpriteBatchNode=cc.Node.extend({_blendFunc:null,_descendants:null,_className:"SpriteBatchNode",ctor:function(a,b){cc.Node.prototype.ctor.call(this);this._descendants=[];this._blendFunc=new cc.BlendFunc(cc.BLEND_SRC,cc.BLEND_DST);var c;b=b||cc.SpriteBatchNode.DEFAULT_CAPACITY;cc.isString(a)?(c=cc.textureCache.getTextureForKey(a))||(c=cc.textureCache.addImage(a)):a instanceof cc.Texture2D&&(c=a);c&&this.initWithTexture(c,b)},addSpriteWithoutQuad:function(a,b,c){cc.assert(a,cc._LogInfos.SpriteBatchNode_addSpriteWithoutQuad_2);
...
cc.renderer;this.calculateDeltaTime();this._paused||(this._scheduler.update(this._deltaTime),cc.eventManager.dispatchEvent(this._eventAfterUpdate));this._nextScene&&this.setNextScene();this._beforeVisitScene&&this._beforeVisitScene();this._runningScene&&(!0===a.childrenOrderDirty?(cc.renderer.clearRenderCommands(),cc.renderer.assignedZ=0,this._runningScene._renderCmd._curLevel=0,this._runningScene.visit(),a.resetFlag()):!0===a.transformDirty()&&a.transform());a.clear();this._notificationNode&&this._notificationNode.visit();
...
1));if(c.currentActionSalvaged)c.currentAction=null;else if(c.currentAction.isDone()){c.currentAction.stop();var e=c.currentAction;c.currentAction=null;this.removeAction(e)}c.currentAction=null}this._currentTargetSalvaged&&0===c.actions.length&&this._deleteHashElement(c)&&d--}}});cc.profiler=function(){var a=!1,b=!1,c=0,d=0,e=0,f=0,g=null,h=document.createElement("div"),k=document.createElement("div"),m=document.createElement("div"),n=document.createElement("div"),p=10,s=[0,10,20,30],r=[0,0,0,0],t=3,u=0,z=0;n.id="fps";n.style.position="absolute";n.style.padding="3px";n.style.textAlign="left";n.style.backgroundColor="rgb(0, 0, 34)";n.style.bottom=cc.DIRECTOR_STATS_POSITION.y+"0px";n.style.left=cc.DIRECTOR_STATS_POSITION.x+"px";n.style.width="45px";n.style.height="60px";for(var y=
[m,k,h],v=0;3>v;++v){var w=y[v].style;w.color="rgb(0, 255, 255)";w.font="bold 12px Helvetica, Arial";w.lineHeight="20px";w.width="100%";n.appendChild(y[v])}var A=function(){e=cc.director.getSecondsPerFrame();c++;f+=cc.director.getDeltaTime();if(f>cc.DIRECTOR_FPS_INTERVAL){d=c/f;f=c=0;if(x.onFrameRateChange){var a=d,g=s.length-1,n=g,v=0;u++;for(z+=a;0<=n;n--)if(a>=s[n]){r[n]++;break}if(u>=p){v=z/p;for(n=g;0<n;n--)if(a=r[n]/p,0.6<=a&&v>=s[n]){n!=t&&(t=n,x.onFrameRateChange&&x.onFrameRateChange(v.toFixed(2)));
break}z=u=_changeCount=0;for(n=g;0<n;n--)r[n]=0}}b&&(k.innerText=e.toFixed(3),h.innerText=d.toFixed(1),m.innerText=(0|cc.g_NumberOfDraws).toString())}},x={onFrameRateChange:null,getSecondsPerFrame:function(){return e},getFrameRate:function(){return d},setProfileDuration:function(a){!isNaN(a)&&0<a&&(p=a/cc.DIRECTOR_FPS_INTERVAL)},resumeProfiling:function(){cc.eventManager.addListener(g,1)},stopProfiling:function(){cc.eventManager.removeListener(g)},isShowingStats:function(){return b},showStats:function(){a||
this.init();null===n.parentElement&&cc.container.appendChild(n);b=!0},hideStats:function(){b=!1;n.parentElement===cc.container&&cc.container.removeChild(n)},init:function(){a||(g=cc.eventManager.addCustomListener(cc.Director.EVENT_AFTER_VISIT,A),a=!0)}};return x}();cc.math=cc.math||{};cc.math.EPSILON=0.015625;cc.math.square=function(a){return a*a};cc.math.almostEqual=function(a,b){return a+cc.math.EPSILON>b&&a-cc.math.EPSILON<b};(function(a){a.math.Vec2=function(a,b){void 0===b?(this.x=a.x,this.y=a.y):(this.x=a||0,this.y=b||0)};var b=a.math.Vec2.prototype;b.fill=function(a,b){this.x=a;this.y=b};b.length=function(){return Math.sqrt(a.math.square(this.x)+a.math.square(this.y))};b.lengthSq=function(){return a.math.square(this.x)+a.math.square(this.y)};b.normalize=function(){var a=1/this.length();this.x*=a;this.y*=a;return this};a.math.Vec2.add=function(a,b,e){a.x=b.x+e.x;a.y=b.y+e.y;return a};b.add=function(a){this.x+=a.x;this.y+=
...
k;a[6]=c;a[7]=g;return this};b.determinant=function(){var a=this.mat,b=a[0]*a[4]*a[8]+a[1]*a[5]*a[6]+a[2]*a[3]*a[7];return b-=a[2]*a[4]*a[6]+a[0]*a[5]*a[7]+a[1]*a[3]*a[8]};b.multiply=function(a){var b=this.mat,c=a.mat;a=b[0];var g=b[1],h=b[2],k=b[3],m=b[4],n=b[5],p=b[6],s=b[7],r=b[8],t=c[0],u=c[1],z=c[2],y=c[3],v=c[4],w=c[5],A=c[6],x=c[7],c=c[8];b[0]=a*t+k*u+p*z;b[1]=g*t+m*u+s*z;b[2]=h*t+n*u+r*z;b[3]=h*t+n*u+r*z;b[4]=g*y+m*v+s*w;b[5]=h*y+n*v+r*w;b[6]=a*A+k*x+p*c;b[7]=g*A+m*x+s*c;b[8]=h*A+n*x+r*c;
...
a[2]=n;a[3]=r;a[4]=b;a[6]=p;a[7]=t;a[8]=c;a[9]=k;a[11]=u;a[12]=d;a[13]=m;a[14]=s;return this};a.kmMat4Multiply=function(a,b,c){var d=a.mat,k=b.mat,m=c.mat;c=k[0];b=k[1];var n=k[2],p=k[3],s=k[4],r=k[5],t=k[6],u=k[7],z=k[8],y=k[9],v=k[10],w=k[11],A=k[12],x=k[13],B=k[14],k=k[15],C=m[0],D=m[1],E=m[2],F=m[3],G=m[4],H=m[5],I=m[6],J=m[7],K=m[8],L=m[9],M=m[10],N=m[11],O=m[12],P=m[13],Q=m[14],m=m[15];d[0]=C*c+D*s+E*z+F*A;d[1]=C*b+D*r+E*y+F*x;d[2]=C*n+D*t+E*v+F*B;d[3]=C*p+D*u+E*w+F*k;d[4]=G*c+H*s+I*z+J*A;d[5]=
G*b+H*r+I*y+J*x;d[6]=G*n+H*t+I*v+J*B;d[7]=G*p+H*u+I*w+J*k;d[8]=K*c+L*s+M*z+N*A;d[9]=K*b+L*r+M*y+N*x;d[10]=K*n+L*t+M*v+N*B;d[11]=K*p+L*u+M*w+N*k;d[12]=O*c+P*s+Q*z+m*A;d[13]=O*b+P*r+Q*y+m*x;d[14]=O*n+P*t+Q*v+m*B;d[15]=O*p+P*u+Q*w+m*k;return a};b.multiply=function(a){var b=this.mat,c=a.mat;a=b[0];var d=b[1],k=b[2],m=b[3],n=b[4],p=b[5],s=b[6],r=b[7],t=b[8],u=b[9],z=b[10],y=b[11],v=b[12],w=b[13],A=b[14],x=b[15],B=c[0],C=c[1],D=c[2],E=c[3],F=c[4],G=c[5],H=c[6],I=c[7],J=c[8],K=c[9],L=c[10],M=c[11],N=c[12],
O=c[13],P=c[14],c=c[15];b[0]=B*a+C*n+D*t+E*v;b[1]=B*d+C*p+D*u+E*w;b[2]=B*k+C*s+D*z+E*A;b[3]=B*m+C*r+D*y+E*x;b[4]=F*a+G*n+H*t+I*v;b[5]=F*d+G*p+H*u+I*w;b[6]=F*k+G*s+H*z+I*A;b[7]=F*m+G*r+H*y+I*x;b[8]=J*a+K*n+L*t+M*v;b[9]=J*d+K*p+L*u+M*w;b[10]=J*k+K*s+L*z+M*A;b[11]=J*m+K*r+L*y+M*x;b[12]=N*a+O*n+P*t+c*v;b[13]=N*d+O*p+P*u+c*w;b[14]=N*k+O*s+P*z+c*A;b[15]=N*m+O*r+P*y+c*x;return this};a.getMat4MultiplyValue=function(a,b){var c=a.mat,d=b.mat,k=new Float32Array(16);k[0]=c[0]*d[0]+c[4]*d[1]+c[8]*d[2]+c[12]*d[3];
...
0;this._glContext.deleteProgram(this._programObj);this._programObj=null;for(var a in this._hashForUniforms)delete this._hashForUniforms[a]},getProgram:function(){return this._programObj},retain:function(){},release:function(){}});cc.GLProgram.create=function(a,b){return new cc.GLProgram(a,b)};cc.GLProgram._highpSupported=null;
...
(this.glDisableVertexAttribArray(a),this._vertexAttribTexCoords=!1):0!==a&&this.glDisableVertexAttribArray(a)}}cc.glInvalidateStateCache=function(){cc.kmGLFreeAll();cc._currentProjectionMatrix=-1;if(cc.ENABLE_GL_STATE_CACHE){cc._currentShaderProgram=-1;for(var a=0;a<cc.MAX_ACTIVETEXTURE;a++)cc._currentBoundTexture[a]=-1;cc._blendingSource=-1;cc._blendingDest=-1;cc._GLServerState=0}};cc.glUseProgram=function(a){a!==cc._currentShaderProgram&&(cc._currentShaderProgram=a,cc._renderContext.useProgram(a))};
...
cc.glBlendResetToCache=function(){var a=cc._renderContext;a.blendEquation(a.FUNC_ADD);cc.ENABLE_GL_STATE_CACHE?cc.setBlending(cc._blendingSource,cc._blendingDest):cc.setBlending(a.BLEND_SRC,a.BLEND_DST)};cc.setProjectionMatrixDirty=function(){cc._currentProjectionMatrix=-1};cc.glBindTexture2D=function(a){cc.glBindTexture2DN(0,a)};
cc.glBindTexture2DN=function(a,b){if(cc._currentBoundTexture[a]!==b){cc._currentBoundTexture[a]=b;var c=cc._renderContext;c.activeTexture(c.TEXTURE0+a);b?c.bindTexture(c.TEXTURE_2D,b._webTextureObj):c.bindTexture(c.TEXTURE_2D,null)}};cc.ENABLE_GL_STATE_CACHE||(cc.glBindTexture2DN=function(a,b){var c=cc._renderContext;c.activeTexture(c.TEXTURE0+a);b?c.bindTexture(c.TEXTURE_2D,b._webTextureObj):c.bindTexture(c.TEXTURE_2D,null)});cc.glDeleteTexture=function(a){cc.glDeleteTextureN(0,a)};
...
h=b.lineWidth,k=b.lineColor,m=b.isClosePolygon,n=b.isFill;b=b.isStroke;var p=a.getContext(),s=e[0];p.lineCap=f;g&&a.setFillStyle("rgba("+(0|g.r)+","+(0|g.g)+","+(0|g.b)+","+g.a/255+")");h&&(p.lineWidth=h*c);k&&a.setStrokeStyle("rgba("+(0|k.r)+","+(0|k.g)+","+(0|k.b)+","+k.a/255+")");p.beginPath();p.moveTo(s.x*c,-s.y*d);a=1;for(f=e.length;a<f;a++)p.lineTo(e[a].x*c,-e[a].y*d);m&&p.closePath();n&&p.fill();b&&p.stroke()}}})})();(function(){cc.DrawNode.WebGLRenderCmd=function(a){cc.Node.WebGLRenderCmd.call(this,a);this._needDraw=!0};cc.DrawNode.WebGLRenderCmd.prototype=Object.create(cc.Node.WebGLRenderCmd.prototype);cc.DrawNode.WebGLRenderCmd.prototype.constructor=cc.DrawNode.WebGLRenderCmd;cc.DrawNode.WebGLRenderCmd.prototype.rendering=function(a){a=this._node;0<a._buffer.length&&(cc.glBlendFunc(a._blendFunc.src,a._blendFunc.dst),this._shaderProgram.use(),this._shaderProgram._setUniformForMVPMatrixWithMat4(this._stackMatrix),
a._render())}})();var res={},g_resources=[{type:"font",name:"Avenir Next",srcs:["res/font/aer.woff","res/font/aer.eot","res/font/aer.ttf"]}],i;for(i in res)g_resources.push(res[i]);var Listener=cc.EventListener.create({event:cc.EventListener.TOUCH_ONE_BY_ONE,onTouchBegan:function(){}}),StartLayer=cc.Layer.extend({ctor:function(){this._super();return!0}}),GameLayer=cc.LayerColor.extend({ctor:function(){this._super(cc.color(41,47,55));var a=cc.visibleRect,b=new cc.DrawNode;this.addChild(b);b.drawRect(cc.p(0,a.height-180),cc.p(a.width,a.height),cc.color(28,28,28),0,cc.color(0,0,0));return!0}}),GameScene=cc.Scene.extend({onEnter:function(){this._super();var a=new GameLayer;this.addChild(a)}});cc.game.onStart=function(){!cc.sys.isNative&&document.getElementById("cocosLoading")&&document.body.removeChild(document.getElementById("cocosLoading"));cc.view.enableRetina(cc.sys.os===cc.sys.OS_IOS?!0:!1);cc.view.adjustViewPort(!0);cc.view.setRealPixelResolution(640,960,cc.ResolutionPolicy.SHOW_ALL);cc.view.resizeWithBrowserSize(!0);cc.LoaderScene.preload(g_resources,function(){cc.director.runScene(new GameScene)},this)};cc.game.run();