...
a.LANGUAGE_ENGLISH;a.language=k;var m=k=!1,v="",w=0,z=/android (\d+(?:\.\d+)+)/i.exec(h)||/android (\d+(?:\.\d+)+)/i.exec(c.platform);z&&(k=!0,v=z[1]||"",w=parseInt(v)||0);if(z=/(iPad|iPhone|iPod).*OS ((\d+_?){2,3})/i.exec(h))m=!0,v=z[2]||"",w=parseInt(v)||0;z=a.OS_UNKNOWN;-1!==c.appVersion.indexOf("Win")?z=a.OS_WINDOWS:m?z=a.OS_IOS:-1!==c.appVersion.indexOf("Mac")?z=a.OS_OSX:-1!==c.appVersion.indexOf("X11")&&-1===c.appVersion.indexOf("Linux")?z=a.OS_UNIX:k?z=a.OS_ANDROID:-1!==c.appVersion.indexOf("Linux")&&
(z=a.OS_LINUX);a.os=z;a.osVersion=v;a.osMainVersion=w;a.browserType=a.BROWSER_TYPE_UNKNOWN;(function(){var b=/qqbrowser|chrome|safari|firefox|opr|oupeng|opera/i,c=/mqqbrowser|sogou|qzone|liebao|micromessenger|ucbrowser|360 aphone|360browser|baiduboxapp|baidubrowser|maxthon|mxbrowser|trident|miuibrowser/i.exec(h);c||(c=b.exec(h));b=c?c[0]:a.BROWSER_TYPE_UNKNOWN;"micromessenger"===b?b=a.BROWSER_TYPE_WECHAT:"safari"===b&&h.match(/android.*applewebkit/)?b=a.BROWSER_TYPE_ANDROID:"trident"===b?b=a.BROWSER_TYPE_IE:
...
cc.clone(this.__getters__));this.__setters__&&(c.__setters__=cc.clone(this.__setters__));for(var f=0,h=arguments.length;f<h;++f){var k=arguments[f],m;for(m in k){var n="function"===typeof k[m],p="function"===typeof d[m],s=a.test(k[m]);n&&p&&s?(g.value=function(a,b){return function(){var c=this._super;this._super=d[a];var e=b.apply(this,arguments);this._super=c;return e}}(m,k[m]),Object.defineProperty(e,m,g)):n?(g.value=k[m],Object.defineProperty(e,m,g)):e[m]=k[m];if(n){var r,u;if(this.__getters__&&
this.__getters__[m]){var n=this.__getters__[m],t;for(t in this.__setters__)if(this.__setters__[t]===n){u=t;break}cc.defineGetterSetter(e,n,k[m],k[u]?k[u]:e[u],m,u)}if(this.__setters__&&this.__setters__[m]){n=this.__setters__[m];for(t in this.__getters__)if(this.__getters__[t]===n){r=t;break}cc.defineGetterSetter(e,n,k[r]?k[r]:e[r],k[m],r,m)}}}}c.extend=cc.Class.extend;c.implement=function(a){for(var b in a)e[b]=a[b]};return c}})();
...
-1));var r,u,t;this._colorized?r=g=0:(g=f.renderX,r=f.renderY);u=f.width;t=f.height;m*=c;s*=d;p*=c;n*=d;h&&h._htmlElementObj?(c=h._htmlElementObj,""!==h._pattern?(a.setFillStyle(k.createPattern(c,h._pattern)),k.fillRect(m,s,p,n)):k.drawImage(c,g,r,u,t,m,s,p,n)):(h=e._contentSize,f.validRect&&(f=this._displayedColor,a.setFillStyle("rgba("+f.r+","+f.g+","+f.b+",1)"),k.fillRect(m,s,h.width*c,h.height*d)));(e._flippedX||e._flippedY)&&a.restore();cc.g_NumberOfDraws++}};a._updateColor=function(){var a=
...
h=a._offsetPosition.y,k=e+g.width,m=h+g.height,n=f.tx,p=f.ty,s=f.a,r=f.b,u=f.d,t=-f.c,f=e*s-h*t+n,g=e*r+h*u+p,A=k*s-h*t+n,h=k*r+h*u+p,y=k*s-m*t+n,k=k*r+m*u+p,n=e*s-m*t+n,e=e*r+m*u+p,m=a._vertexZ;cc.SPRITEBATCHNODE_RENDER_SUBPIXEL||(f|=0,g|=0,A|=0,h|=0,y|=0,k|=0,n|=0,e|=0);b.bl.vertices={x:f,y:g,z:m};b.br.vertices={x:A,y:h,z:m};b.tl.vertices={x:n,y:e,z:m};b.tr.vertices={x:y,y:k,z:m}}a.textureAtlas.updateQuad(b,a.atlasIndex);this._dirty=a._recursiveDirty=!1}a._hasChildren&&a._arrayMakeObjectsPerformSelector(a._children,
...
a[2]=n;a[3]=r;a[4]=b;a[6]=p;a[7]=u;a[8]=c;a[9]=k;a[11]=t;a[12]=d;a[13]=m;a[14]=s;return this};a.kmMat4Multiply=function(a,b,c){var d=a.mat,k=b.mat,m=c.mat;c=k[0];b=k[1];var n=k[2],p=k[3],s=k[4],r=k[5],u=k[6],t=k[7],A=k[8],y=k[9],v=k[10],w=k[11],z=k[12],x=k[13],B=k[14],k=k[15],C=m[0],D=m[1],E=m[2],F=m[3],G=m[4],H=m[5],I=m[6],J=m[7],K=m[8],L=m[9],M=m[10],N=m[11],O=m[12],P=m[13],Q=m[14],m=m[15];d[0]=C*c+D*s+E*A+F*z;d[1]=C*b+D*r+E*y+F*x;d[2]=C*n+D*u+E*v+F*B;d[3]=C*p+D*t+E*w+F*k;d[4]=G*c+H*s+I*A+J*z;d[5]=
G*b+H*r+I*y+J*x;d[6]=G*n+H*u+I*v+J*B;d[7]=G*p+H*t+I*w+J*k;d[8]=K*c+L*s+M*A+N*z;d[9]=K*b+L*r+M*y+N*x;d[10]=K*n+L*u+M*v+N*B;d[11]=K*p+L*t+M*w+N*k;d[12]=O*c+P*s+Q*A+m*z;d[13]=O*b+P*r+Q*y+m*x;d[14]=O*n+P*u+Q*v+m*B;d[15]=O*p+P*t+Q*w+m*k;return a};b.multiply=function(a){var b=this.mat,c=a.mat;a=b[0];var d=b[1],k=b[2],m=b[3],n=b[4],p=b[5],s=b[6],r=b[7],u=b[8],t=b[9],A=b[10],y=b[11],v=b[12],w=b[13],z=b[14],x=b[15],B=c[0],C=c[1],D=c[2],E=c[3],F=c[4],G=c[5],H=c[6],I=c[7],J=c[8],K=c[9],L=c[10],M=c[11],N=c[12],
O=c[13],P=c[14],c=c[15];b[0]=B*a+C*n+D*u+E*v;b[1]=B*d+C*p+D*t+E*w;b[2]=B*k+C*s+D*A+E*z;b[3]=B*m+C*r+D*y+E*x;b[4]=F*a+G*n+H*u+I*v;b[5]=F*d+G*p+H*t+I*w;b[6]=F*k+G*s+H*A+I*z;b[7]=F*m+G*r+H*y+I*x;b[8]=J*a+K*n+L*u+M*v;b[9]=J*d+K*p+L*t+M*w;b[10]=J*k+K*s+L*A+M*z;b[11]=J*m+K*r+L*y+M*x;b[12]=N*a+O*n+P*u+c*v;b[13]=N*d+O*p+P*t+c*w;b[14]=N*k+O*s+P*A+c*z;b[15]=N*m+O*r+P*y+c*x;return this};a.getMat4MultiplyValue=function(a,b){var c=a.mat,d=b.mat,k=new Float32Array(16);k[0]=c[0]*d[0]+c[4]*d[1]+c[8]*d[2]+c[12]*d[3];
...
cc.glDeleteTextureN=function(a,b){cc.ENABLE_GL_STATE_CACHE&&b===cc._currentBoundTexture[a]&&(cc._currentBoundTexture[a]=-1);cc._renderContext.deleteTexture(b)};cc.glBindVAO=function(a){cc.TEXTURE_ATLAS_USE_VAO&&cc.ENABLE_GL_STATE_CACHE&&cc._uVAO!==a&&(cc._uVAO=a)};cc.glEnable=function(a){};var res={Paddle_png:"res/paddle.png"},g_resources=[],i;for(i in res)g_resources.push(res[i]);var MainLayer=cc.Layer.extend({ctor:function(){this._super();var a=cc.winSize,b=new cc.Sprite(res.Paddle_png);this.addChild(b);b.attr({x:a.width/2,y:a.height/2,anchorX:0.5,anchorY:0.5});return!0}}),GameScene=cc.Scene.extend({onEnter:function(){this._super();var a=new MainLayer;this.addChild(a)}});cc.game.onStart=function(){!cc.sys.isNative&&document.getElementById("cocosLoading")&&document.body.removeChild(document.getElementById("cocosLoading"));cc.view.enableRetina(cc.sys.os===cc.sys.OS_IOS?!0:!1);cc.view.adjustViewPort(!0);cc.view.setDesignResolutionSize(640,960,cc.ResolutionPolicy.SHOW_ALL);cc.view.resizeWithBrowserSize(!0);cc.LoaderScene.preload(g_resources,function(){cc.director.runScene(new GameScene)},this)};cc.game.run();